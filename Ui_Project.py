...
# Form implementation generated from reading ui file 'd:\University\Semester 6\Software Construction and Development Lab\Project\Project.ui'
#
...
class Ui_MainWindow(object):
    ...
    def RegisteredCourseByStudent(self):
        ...
        self.ui_regCourse.ContentData.setText(courses_text)
    ...
    def opencourseRegistered(self):
        ...
        # Set a monospaced font for the QLabel
        font = QtGui.QFont("Courier New", 10)
        self.ui_Course.Content_Data.setFont(font)
        ...
        if not CoursesList:
            ...
            courses_text += header
            courses_text += "-" * (name_width + prereq_width // 3) + "\n"
    ...
    def openStudentRegisterationCourseAfterHelp(self):
        ...
        # Set the accumulated text to the label
        self.ui_Course.Content_Data.setText(courses_text)
        self.ui_Course.pushButton.clicked.connect(self.openHelp)
        self.window.show()
    ...
    def setupUi(self, MainWindow):
        ...
        self.LoginPage.setGeometry(QtCore.QRect(0, -10, 701, 491))
        ...
        self.LoginButton.setGeometry(QtCore.QRect(390, 350, 91, 41))
...
"font: 87 11pt \"Arial Black\";")
        ...
        self.PassLine.setGeometry(QtCore.QRect(290, 280, 321, 31))
        ...
        self.nameLine.setGeometry(QtCore.QRect(290, 210, 321, 31))
        self.nameLine.setStyleSheet("border-color: rgb(0, 0, 0);")
        self.nameLine.setObjectName("nameLine")
        self.StudentNamelabel = QtWidgets.QLabel(self.LoginPage)
        self.StudentNamelabel.setGeometry(QtCore.QRect(290, 180, 121, 16))
        ...
        self.IDlabel.setGeometry(QtCore.QRect(290, 250, 101, 16))
        ...
        self.LoginDetailLabel.setGeometry(QtCore.QRect(300, 320, 361, 20))
        ...
        self.widget_2.setGeometry(QtCore.QRect(0, 0, 691, 101))
        self.widget_2.setStyleSheet("background-color: rgb(66, 167, 255);")
        self.widget_2.setObjectName("widget_2")
        self.label = QtWidgets.QLabel(self.widget_2)
        self.label.setGeometry(QtCore.QRect(280, 50, 121, 31))
...
"")
        ...
        self.LoginDetailLabel_2.setGeometry(QtCore.QRect(330, 430, 141, 20))
        ...
        self.loginAdvisor.setGeometry(QtCore.QRect(470, 430, 51, 23))
...
"font: 75 10pt \"Arial\";")
        ...
        self.label_2.setGeometry(QtCore.QRect(40, 150, 221, 251))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Student Portal"))
    ...
    def addCourse(self):
        try:
            ...
            self.ui_addC.MESSAGE.setText("Something went Wrong!!!")
    ...
    def updategrades(self):
        try:
            ...
            self.ui_UpdateGrade.Message.setText("Something went wrong!!!")
    ...
    def getID(self):
        try:
            ...
            if id:
                ...
                self.ui_Help.label_3.clear()
            self.ui_Help.CourseName.clear()
        except ValueError:
            self.ui_Help.messagealert.setText("Something went wrong!!!")
